...
Al analizar las variables numéricas con respecto a los valores de la variable objetivo se encuentra que todas las estudiadas tiene un comportamiento similar: de esta manera, la categoría Entregado a Tiempo (0) siempre en menor en cualquieras de los factores de las variables analizadas. Lo cual concuerda con lo analizado al inicio en donde se vio que la categoría 0 es menor que la categoría 1 (40.3% vs 59.7%).
