...
rsumary=rsumary%>%mutate(Variable=rep(c("Llamadas de atención al cliente","Calificación de Cliente","Costo del Producto","Compras Previas","Peso","Descuento Ofrecido"), each=2))%>%select(8,1:7)
datatable(head(rsumary,20), options = list(pageLength = 10, scrollX = TRUE))
```
